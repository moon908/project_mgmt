...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden flex flex-col font-sans">
      ...
      <div className="absolute top-0 left-1/4 w-[500px] h-[500px] rounded-full bg-brand-500/12 blur-[120px] pointer-events-none animate-float" />
      <div className="absolute top-1/3 right-1/4 w-[400px] h-[400px] rounded-full bg-amber-500/10 blur-[100px] pointer-events-none" style={{ animationDelay: '2s' }} />
      <div className="absolute bottom-10 left-1/3 w-[600px] h-[600px] bg-teal-500/8 blur-[150px] pointer-events-none" />
      <div className="absolute top-1/2 left-10 w-[300px] h-[300px] rounded-full bg-rose-500/10 blur-[110px] pointer-events-none" />

      {/* Grid pattern overlay */}
      <div className="absolute inset-0 bg-grid-overlay opacity-30 pointer-events-none" />

      {/* Header Bar */}
      <header className="h-16 border-b border-border relative z-40 bg-card/85 px-6 md:px-12 flex items-center justify-between shadow-sm">
        ...
        <div className="flex items-center gap-4">
          <button 
            ...
            className="flex items-center gap-2 py-2 px-5 rounded-lg bg-primary text-white text-sm font-semibold hover:bg-primary/95 transition-all shadow-md cursor-pointer"
          >
            Enter Dashboard
      ...
      <section className="relative z-10 px-6 md:px-12 py-16 md:py-28 flex flex-col items-center text-center max-w-4xl mx-auto">
        ...
        >
          ...
          <span className="bg-clip-text text-transparent bg-gradient-to-r from-rose-400 via-brand-500 to-amber-500">
        ...
        >
          An Asana-inspired project tracker built for high-performance teams. Auto-breakdown tasks, draft sprint goals, predict roadmap blockers, and coordinate chat instantly.
        </motion.p>
        ...
        >
          ...
          <button
            onClick={() => {
              localStorage.setItem('pf_workspace_mode', 'demo');
              router.push('/dashboard');
            }}
            className="flex items-center justify-center gap-2 py-3.5 px-8 rounded-xl border border-white/10 hover:border-white/20 bg-white/5 text-white text-base font-bold hover:bg-white/10 transition-all cursor-pointer shadow-lg hover:scale-105"
          >
        ...
        <div className="w-full relative mt-8">
          <motion.div
            ...
            className="w-full relative rounded-2xl border border-border bg-card p-1.5 shadow-2xl glass-premium z-10"
            id="demo"
          >
            <div className="rounded-xl border border-border/60 bg-background overflow-hidden">
              {/* Window header */}
              <div className="h-10 border-b border-border bg-card/65 px-4 flex items-center justify-between shrink-0">
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 h-[380px] text-left">
                {/* Mock Sidebar */}
                <div className="border-r border-border bg-secondary/50 p-4 space-y-4 hidden md:block">
                  ...
                  <div className="space-y-1">
                    ...
                    <div className="h-7 hover:bg-secondary rounded-md flex items-center px-3.5 text-xs text-muted-foreground">Kanban Board</div>
                    <div className="h-7 hover:bg-secondary rounded-md flex items-center px-3.5 text-xs text-muted-foreground">Sprint Chat</div>
                    <div className="h-7 hover:bg-secondary rounded-md flex items-center px-3.5 text-xs text-muted-foreground">Analytics</div>
                  </div>
                </div>
                ...
                <div className="col-span-3 p-6 space-y-6 overflow-y-auto">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                    <div className="p-3 bg-secondary/30 rounded-xl border border-border hover:border-border/80 flex flex-col gap-2">
                    ...
                    <div className="p-3 bg-secondary/30 rounded-xl border border-border hover:border-border/80 flex flex-col gap-2">
                      ...
                      <div className="h-1 w-full bg-secondary rounded-full mt-2 overflow-hidden">
                        <div className="h-full bg-rose-500" style={{ width: '70%' }} />
                      </div>
                    </div>
                    <div className="p-3 bg-secondary/30 rounded-xl border border-border hover:border-border/80 flex flex-col gap-2">
                      ...
                      <div className="h-1 w-full bg-secondary rounded-full mt-2 overflow-hidden">
                        <div className="h-full bg-rose-500" style={{ width: '90%' }} />
                      </div>
                    </div>
                  </div>
          ...
          <motion.div
            ...
            className="absolute -bottom-6 left-[8%] right-[8%] h-8 bg-black/60 rounded-full blur-2xl z-0 pointer-events-none"
          />
        </div>
      </section>

      {/* Feature Showcase Tab Grid */}
      <section className="px-6 md:px-12 py-20 border-t border-border bg-secondary/20" id="features">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 rounded-2xl bg-card border border-border hover:border-border/80 transition-all flex flex-col gap-4">
      ...
      {/* Pricing Grid */}
      <section className="px-6 md:px-12 py-20 border-t border-border bg-secondary/10" id="pricing">
        <div className="max-w-5xl mx-auto">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-2xl sm:text-4xl font-bold mb-4">Flexible plans for growing teams</h2>
            <p className="text-sm sm:text-base text-muted-foreground">Use ProjectFlow completely free, or unlock premium features for larger workspaces.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            ...
            <div className="p-6 rounded-2xl bg-card border border-border flex flex-col justify-between">
              ...
              <button 
                onClick={() => router.push('/dashboard')}
                className="w-full py-2.5 rounded-lg border border-border hover:bg-secondary mt-8 text-xs font-semibold transition-colors cursor-pointer"
              >
                Contact Sales
              </button>
            </div>
      ...
      <section className="px-6 md:px-12 py-20 border-t border-border bg-secondary/30" id="faq">
            ...
            {faqData.map((item, idx) => {
              ...
              return (
                <div key={idx} className="border border-border rounded-xl bg-card overflow-hidden">
                  ...
                  {isOpen && (
                    <div className="px-6 pb-4 text-xs sm:text-sm text-muted-foreground border-t border-border pt-3 leading-relaxed animate-in slide-in-from-top duration-200">
                      {item.a}
                    </div>
                  )}
                </div>
      ...
      {/* Footer Section */}
      <footer className="border-t border-border py-12 px-6 md:px-12 bg-card mt-auto shadow-inner">
        <div className="max-w-5xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold text-sm tracking-tight text-foreground">ProjectFlow</span>
          </div>
          ...
          <p className="text-[10px] text-muted-foreground">
            © 2026 ProjectFlow. Inspired by Asana, Jira, and Notion.
          </p>
        </div>
      </footer>
    </div>
